        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
					...
					<center><h4 class="modal-title" id="myModalLabel">Detalles Completo de Compra</h4></center>
                </div>
                <div class="modal-body">
				<?php
					$sales=mysqli_query($conn,"select * from ventas left join cliente on cliente.userid=ventas.userid where salesid='".$sqrow['salesid']."'");
					$srow=mysqli_fetch_array($sales);
				?>
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<span>Cliente: <strong><?php echo ucwords($srow['customer_name']); ?></strong></span>
