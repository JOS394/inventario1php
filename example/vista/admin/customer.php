    ...
    <div class="row">
        <div class="col-lg-12">
            <table width="100%" class="table table-striped table-bordered table-hover" id="cusTable">
                ...
                <tbody>
				<?php
					$cq=mysqli_query($conn,"select * from cliente left join user on user.userid=cliente.userid");
					...
					?>
						<tr>
							...
							<td>
								...
								<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#del_<?php echo $cqrow['userid']; ?>"><i class="fa fa-trash"></i> Borrar</button>
