	<div class="well" style="display:none; position:fixed; top:55px; left:350px; max-width:550px; z-index:2;" id="cart_box">
		...
		<div>
			<button type="button" class="btn btn-warning btn-sm" id="close_cart"><i class="fa fa-times fa-fw"></i> Cerrar</button> <a href="checkout.php" class="btn btn-primary btn-sm"><i class="fa fa-money fa-fw"></i> Revisa</a>
		</div>
	</div>
