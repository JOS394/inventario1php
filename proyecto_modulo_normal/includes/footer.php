...
<footer class="page-footer font-small unique-color-dark">
    ...
    <div class="container">
      ...
      <div class="row py-4 d-flex align-items-center text-white">
        ...
        <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0 text-white">
          <h6 class="mb-0">Conectate con nosotros por medio de tus redes sociales</h6>
        </div>
        <!-- Grid column -->
  ...
  <div class="container text-center text-md-left mt-5 text-white">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 text-white">
        ...
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>
          <i class="fas fa-home mr-3"></i> Santa Ana, SA, ESA</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> joseespana94@example.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> + 503 7523 9447</p>
        <p>
          <i class="fas fa-print mr-3"></i> + 503 2426 0272</p>
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3 text-white">© 2019 Copyright UNICAES
  </div>
  <!-- Copyright -->
